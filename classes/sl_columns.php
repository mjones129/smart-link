...
class SLColumns
{
    ...
    {
        $actions['sl_copy_link'] = '<a data-id="' . $post->ID . '" data-nonce="' . wp_create_nonce('sl-copy-link_' . $post->ID) . '" id="sl-copy-link-' . $post->ID . '" style="cursor:pointer;">' . __('Copy Private Link') . '</a>';
        return $actions;
    }
}
